  ...
  <div class="text-white flex items-center justify-center flex-col pt-28">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4  p-10 ">
      ...
      @mouseleave="isHovered = false"
        ...
        class=" hover:scale-105  transition-transform block rounded-xl border bg-black bg-opacity-50 border-gray-800 p-4">
        ...
        <span class="inline-block rounded-lg p-3">
          <div class="inline-flex align-middle justify-center items-center select-none text-white">
            <svg class="" viewBox="0 0 25 24" fill="none" xmlns="http://www.w3.org/2000/svg" height="32" width="32">
              <path
